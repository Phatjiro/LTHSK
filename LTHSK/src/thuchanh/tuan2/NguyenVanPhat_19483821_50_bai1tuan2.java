...
public class NguyenVanPhat_19483821_50_bai1tuan2 extends JFrame implements ActionListener, MouseListener{
	...
	private NhanVienCollection dsNV;
	...
	public NguyenVanPhat_19483821_50_bai1tuan2() {
		...
		// ArrayList
		dsNV = new NhanVienCollection();
		
		NhanVien nv1 = new NhanVien("1111","Nguyen","Van A",18,false,4500);
		NhanVien nv2 = new NhanVien("2222","Nguyen","Van B",19,false,5000);
		NhanVien nv3 = new NhanVien("3333","Nguyen","Van C",20,true,5500);
		NhanVien nv4 = new NhanVien("4444","Nguyen","Van D",21,true,6000);
	...
	public String ktGioiTinh(NhanVien nv) {
	...
	public void arrayToModel() {
		for(int i=0; i<dsNV.getSize(); i++) {
			NhanVien nv = dsNV.getElement(i);
			tableModel.addRow(new Object[] {nv.getMaNV(),nv.getHoNV(),nv.getTenNV(),ktGioiTinh(nv),
					nv.getTuoi(), myFormat.format(nv.getTienLuong()) + " $"});
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnXoaTrang)) {
			...
			txtHo.setText("");
			txtTen.setText("");
			rdbGioiTinh.setSelected(false);
			txtTuoi.setText("");
			txtTienLuong.setText("");
		}
	}

	public boolean ktGioiTinh2(Object gt) {
		if(gt.equals("Nữ")) {
			return true;
		}
		else {
	...
	public void mouseClicked(MouseEvent e) {
		...
		txtTienLuong.setText(tableModel.getValueAt(row, 5).toString());
		rdbGioiTinh.setSelected(ktGioiTinh2(tableModel.getValueAt(row, 3)));
		System.out.println(":<<<<<<<<");
	}
